...
perl -I ../lib ../scripts/perl/anchorPileUp.pl -i ../sample-data/anchorPileUp/NPC_chrX.matrix.gz --abf ../sample-data/anchorPileUp/Xi-escapees.bed --azs 50000000 --ez --maxDist 50000000 
...
perl -I ../lib ../scripts/perl/heatmap.pl -i ../sample-data/anchorPileUp/NPC_chrX.matrix.gz --hbf ../sample-data/anchorPileUp/Xi-escapees.bed --hc cyan
