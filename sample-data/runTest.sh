...
perl -I ../lib ../scripts/perl/elementPurge.pl -i ../sample-data/addMatrixHeaders/K5.matrix.gz --ic --ta 0.5
...
perl -I ../lib ../scripts/perl/matrix2elementPlot.pl -i ../sample-data/addMatrixHeaders/K5.matrix.gz
perl -I ../lib/ ../scripts/perl/matrix2bed12.pl -i ../sample-data/matrix2elementPlot/K5-highlight.matrix --start 1
