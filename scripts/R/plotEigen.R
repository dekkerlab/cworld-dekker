...
plotEigen(x,data$eigen1,paste("prinicple compenent #1",sep="\n"))
plotEigen(x,data$eigen2,paste("prinicple compenent #2",sep="\n"))
plotEigen(x,data$eigen3,paste("prinicple compenent #3",sep="\n"))
