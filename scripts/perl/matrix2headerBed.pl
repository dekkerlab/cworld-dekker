...
sub intro() {
    ...
    print STDERR "Tool:\t\tmatrix2headerBed.pl\n";
    print STDERR "Version:\t".$cworld::dekker::VERSION."\n";
    print STDERR "Summary:\tdump matrix headers as BED file\n";
...
sub help() {
    ...
    print STDERR "Usage: perl matrix2headerBed.pl [OPTIONS] -i <inputMatrix>\n";
